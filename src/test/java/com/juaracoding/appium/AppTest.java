...
public class AppTest {
    ...
    public void additionTest() throws InterruptedException {
        WebElement buttonClear =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/clr"));
        WebElement button9 =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/digit_9"));
        WebElement button5 =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/digit_5"));
        WebElement buttonPlus =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/op_add"));
        WebElement buttonEqual =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/eq"));
        ...
        WebElement resultView =
                driver.findElement(AppiumBy.id("com.google.android.calculator:id/result_final"));
        String expected = "14";
